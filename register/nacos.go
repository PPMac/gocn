...
type GocnNacosRegister struct {
	cli naming_client.INamingClient
}

func (r *GocnNacosRegister) CreateCli(option Option) error {
	// 创建clientConfig的另一种方式
	//clientConfig := *constant.NewClientConfig(
	//	constant.WithNamespaceId(""), //当namespace是public时，此处填空字符串。
	//	constant.WithTimeoutMs(5000),
...
func (r *GocnNacosRegister) RegisterService(serviceName string, host string, port int) error {
...
func (r *GocnNacosRegister) GetValue(serviceName string) (string, error) {
...
func (r *GocnNacosRegister) Close() error {
	return nil
}
